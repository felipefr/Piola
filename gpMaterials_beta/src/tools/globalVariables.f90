...
integer , parameter :: maxMatPar = 9, maxDamagePar = 7, NdimE = 2
...
subroutine addToTcoh(PKmu,normal,dVmu,iElem,IelemBegin,IelemEnd)
	...
	integer , parameter :: OUnitTcoh = 85, NdimE = 2
	...
	if(iElem == IelemEnd) then
		...
		write(OUnitTcoh,*) Tcoh(1)
		write(OUnitTcoh,*) Tcoh(2)
