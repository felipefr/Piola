...
init_seed, PI, deltaKron, VotimesW,  getIJfromK, iShiftKL, iShiftIJKL, numPrint, getSlice, getSliceAllocate, &
getT2fromV, getT4fromV,  getVfromT2, getVfromT4, &
setAEandBEfib, setAEandBE_lagrangeMultipliers, setCoupling_lagrangeMultipliers, setCoupling_pureDisplacement, & 
...
voigtTen4toTen2, voigtTen2toVec, MatDet

interface numPrint !! overloading of function
