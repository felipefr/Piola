!     ------------------------------------------------------------------
Subroutine computeTangHomGen(AE, BE, MaxLRows, XLL, NDim, iDofT, NodELT, Sol0, Sol1, CommonPar, Param, JParam, DelT, DTm, Time)
!     ------------------------------------------------------------------
	use funcAux
	use loadingLib
	...
	Real*8 :: U(NdimE), GradU(NdimE,NdimE) , F(NdimE,NdimE), detF
	...
	real*8 , allocatable ::  SolU(:) , Xel(:), SolDeltaUkl(:,:,:) !! all have dimension NodG*NdimE
	integer :: iShiftDeltaU , iShiftU , iShiftC, iAux, ipDofDeltaU, NElem,  IdamageModify
...
!%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Subroutine computeTangHomGenS(Coupling,CommonPar,iDofT,Ndim,MaxLRows,iAdd)
!%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	use funcAux
	use ptsGaussLib2
    IMPLICIT NONE
