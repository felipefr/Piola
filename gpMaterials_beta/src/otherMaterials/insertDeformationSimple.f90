...
Subroutine insertDeformationSimple &
...
!~     integer , save :: ElmNumber = 0
    ...
    integer ::  i ,j, ip , nbFtype,  nbLoadType, iShiftMinDetQ, evolStyle, LoadTypeProg,LoadType, iLoadType
	...
	LoadTypeProg = nint(LoadParGen(2))
	LoadPar = LoadParGen(3:8)

	call evolutionF(1,LoadPar,Time,delT,LoadTypeProg,LoadType,NdimE,evolStyle)
...
!%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Subroutine insertDeformationSimpleS(Coupling,CommonPar,iDofT,Ndim,MaxLRows,iAdd)
!%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
