...
!     ------------------------------------------------------------------
Subroutine minRestrictionFibresAniso(AE, BE, MaxLRows, XLL, NDim, iDofT, NodELT, Sol0, &
...
!     ------------------------------------------------------------------
	...
	Real*8 :: eps, pen 
	Real*8 :: afib(NdimE), Areafib, Lfib, signal, BT(NdimE,NdimE) , v(NdimE)
...
!%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Subroutine minRestrictionFibresAnisoS(Coupling,CommonPar,iDofT,Ndim,MaxLRows,iAdd)
!%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
	use funcAux
